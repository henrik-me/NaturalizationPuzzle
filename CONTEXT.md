...
11. **Tag-based study filters** (deferred follow-up to #8) — adds `Question.Tags` (people / wars / documents / time-period) with a small EF migration, seed update for all 128 questions, and a tag-chip UI grouped by namespace. Plan saved separately for the next session.

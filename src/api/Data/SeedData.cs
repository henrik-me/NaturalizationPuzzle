...
public static class SeedData
{
    public static void Seed(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Question>().HasData(
            ...
            new Question { Id = 1, Text = "What is the form of government of the United States?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = true },
            new Question { Id = 2, Text = "What is the supreme law of the land?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = true },
            new Question { Id = 3, Text = "Name one thing the U.S. Constitution does.", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 4, Text = "The U.S. Constitution starts with the words \"We the People.\" What does \"We the People\" mean?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 5, Text = "How are changes made to the U.S. Constitution?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 6, Text = "What does the Bill of Rights protect?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = true },
            new Question { Id = 7, Text = "How many amendments does the U.S. Constitution have?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = true },
            new Question { Id = 8, Text = "Why is the Declaration of Independence important?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 9, Text = "What founding document said the American colonies were free from Britain?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 10, Text = "Name two important ideas from the Declaration of Independence and the U.S. Constitution.", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 11, Text = "The words \"Life, Liberty, and the pursuit of Happiness\" are in what founding document?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 12, Text = "What is the economic system of the United States?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 13, Text = "What is the rule of law?", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = false },
            new Question { Id = 14, Text = "Many documents influenced the U.S. Constitution. Name one.", Category = "American Government", SubCategory = "Principles of American Government", Is6520Designated = true },

            // American Government — System of Government (Q15–62)
            new Question { Id = 15, Text = "There are three branches of government. Why?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 16, Text = "Name the three branches of government.", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 17, Text = "The President of the United States is in charge of which branch of government?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 18, Text = "What part of the federal government writes laws?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 19, Text = "What are the two parts of the U.S. Congress?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 20, Text = "Name one power of the U.S. Congress.", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 21, Text = "How many U.S. senators are there?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 22, Text = "How long is a term for a U.S. senator?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 23, Text = "Who is one of your state's U.S. senators now?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 24, Text = "How many voting members are in the House of Representatives?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 25, Text = "How long is a term for a member of the House of Representatives?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 26, Text = "Why do U.S. representatives serve shorter terms than U.S. senators?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 27, Text = "How many senators does each state have?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 28, Text = "Why does each state have two senators?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 29, Text = "Name your U.S. representative.", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 30, Text = "What is the name of the Speaker of the House of Representatives now?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 31, Text = "Who does a U.S. senator represent?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 32, Text = "Who elects U.S. senators?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 33, Text = "Who does a member of the House of Representatives represent?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 34, Text = "Who elects members of the House of Representatives?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 35, Text = "Some states have more representatives than other states. Why?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 36, Text = "The President of the United States is elected for how many years?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 37, Text = "The President of the United States can serve only two terms. Why?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 38, Text = "What is the name of the President of the United States now?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 39, Text = "What is the name of the Vice President of the United States now?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 40, Text = "If the president can no longer serve, who becomes president?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 41, Text = "Name one power of the president.", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 42, Text = "Who is Commander in Chief of the U.S. military?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 43, Text = "Who signs bills to become laws?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 44, Text = "Who vetoes bills?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 45, Text = "Who appoints federal judges?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 46, Text = "The executive branch has many parts. Name one.", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 47, Text = "What does the President's Cabinet do?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 48, Text = "What are two Cabinet-level positions?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 49, Text = "Why is the Electoral College important?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 50, Text = "What is one part of the judicial branch?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 51, Text = "What does the judicial branch do?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 52, Text = "What is the highest court in the United States?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = true },
            new Question { Id = 53, Text = "How many seats are on the Supreme Court?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 54, Text = "How many Supreme Court justices are usually needed to decide a case?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 55, Text = "How long do Supreme Court justices serve?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 56, Text = "Supreme Court justices serve for life. Why?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 57, Text = "Who is the Chief Justice of the United States now?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 58, Text = "Name one power that is only for the federal government.", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 59, Text = "Name one power that is only for the states.", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 60, Text = "What is the purpose of the 10th Amendment?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 61, Text = "Who is the governor of your state now?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },
            new Question { Id = 62, Text = "What is the capital of your state?", Category = "American Government", SubCategory = "System of Government", Is6520Designated = false },

            // American Government — Rights and Responsibilities (Q63–72)
            new Question { Id = 63, Text = "There are four amendments to the U.S. Constitution about who can vote. Describe one of them.", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 64, Text = "Who can vote in federal elections, run for federal office, and serve on a jury in the United States?", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 65, Text = "What are three rights of everyone living in the United States?", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 66, Text = "What do we show loyalty to when we say the Pledge of Allegiance?", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 67, Text = "Name two promises that new citizens make in the Oath of Allegiance.", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 68, Text = "How can people become United States citizens?", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 69, Text = "What are two examples of civic participation in the United States?", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 70, Text = "What is one way Americans can serve their country?", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 71, Text = "Why is it important to pay federal taxes?", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },
            new Question { Id = 72, Text = "It is important for all men age 18 through 25 to register for the Selective Service. Name one reason why.", Category = "American Government", SubCategory = "Rights and Responsibilities", Is6520Designated = false },

            // American History — Colonial Period and Independence (Q73–89)
            new Question { Id = 73, Text = "The colonists came to America for many reasons. Name one.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = true },
            new Question { Id = 74, Text = "Who lived in America before the Europeans arrived?", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 75, Text = "What group of people was taken and sold as slaves?", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 76, Text = "What war did the Americans fight to win independence from Britain?", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = true },
            new Question { Id = 77, Text = "Name one reason why the Americans declared independence from Britain.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 78, Text = "Who wrote the Declaration of Independence?", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 79, Text = "When was the Declaration of Independence adopted?", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = true },
            new Question { Id = 80, Text = "The American Revolution had many important events. Name one.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 81, Text = "There were 13 original states. Name five.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 82, Text = "What founding document was written in 1787?", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 83, Text = "The Federalist Papers supported the passage of the U.S. Constitution. Name one of the writers.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 84, Text = "Why were the Federalist Papers important?", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 85, Text = "Benjamin Franklin is famous for many things. Name one.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 86, Text = "George Washington is famous for many things. Name one.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 87, Text = "Thomas Jefferson is famous for many things. Name one.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 88, Text = "James Madison is famous for many things. Name one.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },
            new Question { Id = 89, Text = "Alexander Hamilton is famous for many things. Name one.", Category = "American History", SubCategory = "Colonial Period and Independence", Is6520Designated = false },

            // American History — The 1800s (Q90–99)
            new Question { Id = 90, Text = "What territory did the United States buy from France in 1803?", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 91, Text = "Name one war fought by the United States in the 1800s.", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 92, Text = "Name the U.S. war between the North and the South.", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 93, Text = "The Civil War had many important events. Name one.", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 94, Text = "Abraham Lincoln is famous for many things. Name one.", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 95, Text = "What did the Emancipation Proclamation do?", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 96, Text = "What U.S. war ended slavery?", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 97, Text = "What amendment says all persons born or naturalized in the United States are U.S. citizens?", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 98, Text = "When did all men get the right to vote?", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },
            new Question { Id = 99, Text = "Name one leader of the women's rights movement in the 1800s.", Category = "American History", SubCategory = "The 1800s", Is6520Designated = false },

            // American History — Recent American History (Q100–118)
            new Question { Id = 100, Text = "Name one war fought by the United States in the 1900s.", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 101, Text = "Why did the United States enter World War I?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 102, Text = "When did all women get the right to vote?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 103, Text = "What was the Great Depression?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 104, Text = "When did the Great Depression start?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 105, Text = "Who was president during the Great Depression and World War II?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 106, Text = "Why did the United States enter World War II?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 107, Text = "Dwight Eisenhower is famous for many things. Name one.", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 108, Text = "Who was the United States' main rival during the Cold War?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 109, Text = "During the Cold War, what was one main concern of the United States?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 110, Text = "Why did the United States enter the Korean War?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 111, Text = "Why did the United States enter the Vietnam War?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 112, Text = "What did the civil rights movement do?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 113, Text = "Martin Luther King, Jr. is famous for many things. Name one.", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 114, Text = "Why did the United States enter the Persian Gulf War?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 115, Text = "What major event happened on September 11, 2001 in the United States?", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 116, Text = "Name one U.S. military conflict after the September 11, 2001 attacks.", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 117, Text = "Name one American Indian tribe in the United States.", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },
            new Question { Id = 118, Text = "Name one example of an American innovation.", Category = "American History", SubCategory = "Recent American History", Is6520Designated = false },

            // Integrated Civics — Symbols and Holidays (Q119–128)
            new Question { Id = 119, Text = "What is the capital of the United States?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = true },
            new Question { Id = 120, Text = "Where is the Statue of Liberty?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = false },
            new Question { Id = 121, Text = "Why does the flag have 13 stripes?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = false },
            new Question { Id = 122, Text = "Why does the flag have 50 stars?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = false },
            new Question { Id = 123, Text = "What is the name of the national anthem?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = true },
            new Question { Id = 124, Text = "The Nation's first motto was \"E Pluribus Unum.\" What does that mean?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = false },
            new Question { Id = 125, Text = "What is Independence Day?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = false },
            new Question { Id = 126, Text = "Name three national U.S. holidays.", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = false },
            new Question { Id = 127, Text = "What is Memorial Day?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = false },
            new Question { Id = 128, Text = "What is Veterans Day?", Category = "Integrated Civics", SubCategory = "Symbols and Holidays", Is6520Designated = false }
        );
